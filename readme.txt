...
Contributors: jomres
Tags: Booking, booking system, booking portal, room booking, online booking software, online reservation, online reservation system, reservation calendar, reservation system, website booking system, hotel booking, villa booking
...
**Philosophy:** Jomres has been built with the mindset that the data you create is yours, and nobody elses. Jomres is not a SAAS/cloud based system where you pay a monthly fee and the availability is subject to the profitability (or otherwise) of a hosting service. Once it's downloaded and installed it's yours to use for the lifetime of your project.
